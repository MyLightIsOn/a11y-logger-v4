...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive over:underline a11y-focus dark:focus:outline-white focus:outline-black focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black dark:hover:bg-white dark:hover:text-black",
  {
    variants: {
      variant: {
        default:
